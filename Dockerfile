...
RUN apt-get -y update && apt-get -y upgrade && apt-get install -y python3-pip sane sane-utils libusb-0.1 ghostscript netpbm ocrmypdf && apt-get -y clean && rm -rf /var/lib/apt/lists/*
